...
function bindActions(){
  ...
  qs('#pdfLedgerBtn').addEventListener('click',()=>exportPdf('كشف_حساب',state.ledgerRows));
  qs('#pdfReportBtn').addEventListener('click',()=>exportPdf('تقرير',state.reportRows));
  qs('#pdfAllOperationsBtn').addEventListener('click',()=>exportPdf('كل_العمليات',state.operations));
